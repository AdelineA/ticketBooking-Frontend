          ...
          <div class="px-0.5 pt-0.5 lg:px-8 ">
            <nav class="flex items-center">
              ...
              <div class="hidden lg:flex lg:gap-x-12 font-bold">
                <NavLink to="/" class="text-base text-white font-bold">
                  Home
                </NavLink>

                <NavLink to="/service" class="text-base text-white font-bold">
                  Service
                </NavLink>
                <NavLink to="/Busbook" class="text-base text-white font-bold">
                  About Us
                </NavLink>
              </div>
              <div class="flex lg:flex lg:flex-1 lg:justify-end font-bold mr-10 ">
                ...
                <NavLink to="login" class="text-base text-white font-bold ">
                  LogIn
                </NavLink>
              </div>
            </nav>
